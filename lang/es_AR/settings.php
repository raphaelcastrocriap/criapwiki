...
return [
    ...
    'app_default_editor' => 'Editor de Tópico por defecto',
    'app_default_editor_desc' => 'Seleccione qué editor se utilizará por defecto cuando se editen nuevas tópicos. Esta acción se puede anular al nivel de tópico si los permisos lo permiten.',
    'app_custom_html' => 'Contenido de cabecera HTML personalizable',
    'app_custom_html_desc' => 'Cualquier contenido agregado aquí será agregado al final de la sección <head> de cada tópico. Esto es útil para sobreescribir estilos o agregar código para analíticas.',
    ...
    'app_homepage' => 'Tópico de inicio de la Aplicación',
    'app_homepage_desc' => 'Seleccione una tópico de inicio para mostrar en lugar de la vista por defecto. Se ignoran los permisos de tópico para las tópicos seleccionadas.',
    'app_homepage_select' => 'Seleccione una tópico',
    ...
    'app_disable_comments_desc' => 'Deshabilitar comentarios en todas las tópicos de la aplicación. Los comentarios existentes no se muestran.',
    ...
    'content_colors_desc' => 'Establece los colores para todos los elementos en la jerarquía de organización de la tópico. Se recomienda elegir colores con un brillo similar al predeterminado para mayor legibilidad.',
    ...
    'maint_image_cleanup_desc' => 'Analizar contenido de tópicos y revisiones para detectar cuáles imágenes y dibujos están en uso y cuáles son redundantes. Asegúrese de crear un respaldo completo de imágenes y base de datos antes de ejecutar esta tarea.',
    'maint_delete_images_only_in_revisions' => 'También elimina imágenes que sólo existen en antiguas revisiones de tópicos',
    ...
    'maint_timeout_command_note' => 'Documentação: Esta acción puede tardar en ejecutarse, lo que puede derivar en problemas de tiempo de espera en algunos entornos web. Como alternativa, esta acción se puede realizar usando un comando de terminal.',
    ...
    s propios, artigos y tópicos',
    'role_manage_page_templates' => 'Gestionar las plantillas de tópicos',
    ...
    'role_asset_desc' => 'Estos permisos controlan el acceso por defecto a los activos del sistema. Permisos definidos en Libros, Artigos y Tópicos ignorarán estos permisos.',
