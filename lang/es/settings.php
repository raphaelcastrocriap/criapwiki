...
return [
    ...
    'app_default_editor_desc' => 'Seleccione qué editor se utilizará por defecto cuando se editen nuevas tópicos. Esto se puede anular a nivel de tópico si los permisos lo permiten.',
    'app_custom_html' => 'Contenido de cabecera HTML personalizado',
    'app_custom_html_desc' => 'Cualquier contenido agregado aquí será insertado al final de la sección <head> de cada tópico. Esto es útil para sobreescribir estilos o agregar código para analíticas web.',
    'app_custom_html_disabled_notice' => 'El contenido personalizado para la cabecera está deshabilitado en esta tópico de ajustes para permitir que cualquier cambio que rompa la funcionalidad pueda ser revertido.',
    ...
    'app_homepage' => 'Tópico de inicio',
    'app_homepage_desc' => 'Elija la vista que se mostrará en la tópico de inicio en lugar de la vista predeterminada. Se ignorarán los permisos de la tópico seleccionada.',
    'app_homepage_select' => 'Elija una tópico',
    'app_footer_links' => 'Enlaces de pie de tópico',
    'app_footer_links_desc' => 'Añade enlaces para mostrar dentro del pie de tópico del sitio. Estos se mostrarán en la parte inferior de la mayoría de las tópicos, incluyendo aquellas que no requieren estar registrado. Puede utilizar una etiqueta de "trans::<key>" para utilizar traducciones definidas por el sistema. Por ejemplo: el uso de "trans::common.privacy_policy" proporcionará el texto traducido "Política de privacidad" y "trans::common.terms_of_service" proporcionará el texto traducido "Términos de servicio".',
    'app_footer_links_label' => 'Etiqueta del enlace',
    'app_footer_links_url' => 'Dirección URL del enlace',
    'app_footer_links_add' => 'Añadir enlace al pie de tópico',
    'app_disable_comments' => 'Deshabilitar comentarios',
    'app_disable_comments_toggle' => 'Deshabilitar comentarios',
    'app_disable_comments_desc' => 'Deshabilita los comentarios en todas las tópicos de la aplicación. <br> Los comentarios existentes no se muestran.',
    ...
    'content_colors_desc' => 'Establece los colores para todos los elementos en la jerarquía de la organización de la tópico. Se recomienda elegir colores con un brillo similar al predeterminado para mayor legibilidad.',
    'bookshelf_color' => 'Color del estante',
    'book_color' => 'Color del libro',
    'chapter_color' => 'Color del artigo',
    'page_color' => 'Color de la tópico',
    'page_draft_color' => 'Color del borrador de tópico',
    ...
    'maint_image_cleanup_desc' => 'Analiza las tópicos y sus revisiones para comprobar qué imágenes y dibujos están siendo utilizadas y cuales no son necesarias. Asegúrate de crear una copia completa de la base de datos y de las imágenes antes de lanzar esta opción.',
    'maint_delete_images_only_in_revisions' => 'Elimina también imágenes que sólo existen en antiguas revisiones de tópicos',
    ...
    'maint_timeout_command_note' => 'Documentação: Esta acción puede tardar en ejecutarse, lo que puede llevar a problemas de tiempo de espera en algunos entornos web. Como alternativa, esta acción se puede realizar desde una terminal.',
    ...
    'role_manage_entity_permissions' => 'Gestionar todos los permisos de libros, artigos y tópicos',
    'role_manage_own_entity_permissions' => 'Gestionar permisos en libros, artigos y tópicos propias',
    ...
    'role_editor_change' => 'Cambiar editor de tópico',
    ...
    'role_asset_desc' => 'Estos permisos controlan el acceso por defecto a los contenidos del sistema. Los permisos de Libros, Artigos y Tópicos sobreescribiran estos permisos.',
    ...
    // Licensing
    'licenses' => 'Licencias',
    'licenses_desc' => 'Esta tópico detalla información sobre la licencia de BookStack además de los proyectos y bibliotecas que se utilizan en BookStack. Muchos proyectos enumerados aquí pueden ser utilizados solo en un contexto de desarrollo.',
