...
return [
    ...
    'app_default_editor_desc' => 'Selecione qual editor será usado por padrão ao editar novas tópicos. Isto pode ser substituído a nível de tópico onde as permissões estiverem disponíveis.',
    'app_custom_html' => 'Conteúdo personalizado para para o Head do HTML',
    'app_custom_html_desc' => 'Quaisquer conteúdos aqui adicionados serão inseridos no final da secção <head> de cada tópico. Esta é uma maneira útil de sobrescrever estilos e adicionar códigos de análise de site.',
    'app_custom_html_disabled_notice' => 'O conteúdo personalizado do <head> HTML está desativado nesta tópico de configurações, para garantir que quaisquer alterações que acabem maliciosas possam ser revertidas.',
    ...
    'app_disable_comments_desc' => 'Desativar comentários em todas as tópicos da aplicação.<br> Comentários existentes não serão exibidos.',
    ...
    'content_colors_desc' => 'Definir cores para todos os elementos na hierarquia da organização da tópico. Escolher cores com um brilho semelhante às cores padrão é recomendado para a legibilidade.',
    ...
    'maint_image_cleanup_desc' => 'Examina tópicos e reviste os seus conteúdos para verificar quais imagens e desenhos estão atualmente em uso e quais são redundantes. Certifique-se de criar uma cópia de segurança completa da base de dados e imagens antes de executar esta ação.',
    'maint_delete_images_only_in_revisions' => 'Eliminar também imagens que existam apenas em revisões de tópico antigas',
    ...
    'maint_recycle_bin_desc' => 'Departamentos, documentações, artigos e tópicos eliminados são mandados para a reciclagem podendo assim ser restaurados ou excluídos permanentemente. Itens mais antigos da podem vir a ser automaticamente removidos da reciclagem após um tempo, dependendo da configuração do sistema.',
    ...
    'maint_timeout_command_note' => 'Documentação: Esta ação pode levar algum tempo para executar, retornando \'timeout\' em alguns ambientes web. Como alternativa, esta ação pode ser executada via terminal.',
    ...
    'role_manage_entity_permissions' => 'Gerir todos os documentações, artigos e permissões de tópicos',
    'role_manage_own_entity_permissions' => 'Gerir permissões de seu próprio documentação, artigo e paginas',
    'role_manage_page_templates' => 'Gerir modelos de tópico',
    ...
    'role_editor_change' => 'Alterar editor de tópico',
    ...
    'role_asset_desc' => 'Estas permissões controlam o acesso padrão para os ativos dentro do sistema. Permissões em Documentações, Artigos e Tópicos serão sobrescritas por estas permissões.',
