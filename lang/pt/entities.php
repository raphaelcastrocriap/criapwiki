...
return [
    ...
    'shelves_books' => 'Livros nesta departamento',
    'shelves_add_books' => 'Adicionar livros a esta departamento',
    'shelves_drag_books' => 'Arraste os livros abaixo para adicioná-los a esta prateleira',
    'shelves_empty_contents' => 'Esta departamento não tem livros atribuídos',
    'shelves_edit_and_assign' => 'Editar departamento para atribuir livros',
    ...
    'shelves_delete_explain' => "A ação vai eliminar a departamento ':name'. Os livros nela presentes não serão eliminados.",
    ...
    'shelves_permissions_cascade_warning' => 'As permissões nas departamentos não são passadas automaticamente em efeito dominó para os livros contidos. Isto acontece porque um livro pode existir em várias departamentos. As permissões podem, no entanto, ser copiadas para livros filhos usando a opção abaixo.',
    ...
    'shelves_copy_permissions_explain' => 'Isto aplicará as configurações de permissões atuais desta departamento a todos os livros nela contidos. Antes de ativar, assegure-se de que quaisquer alterações nas permissões desta departamento foram guardadas.',
    'shelves_copy_permission_success' => 'Permissões da departamento copiadas para :count livros',
