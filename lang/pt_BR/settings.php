...
return [
    ...
    'maint_recycle_bin_desc' => 'Prateleiras, notas, capítulos e páginas deletados são mandados para a lixeira podendo assim ser restaurados ou excluídos permanentemente. Itens mais antigos da lixeira podem vir a ser automaticamente removidos da lixeira após um tempo dependendo da configuração do sistema.',
    ...
    'role_manage_entity_permissions' => 'Gerenciar todos os notas, capítulos e permissões de páginas',
    'role_manage_own_entity_permissions' => 'Gerenciar permissões de seu próprio nota, capítulo e paginas',
    ...
    'role_asset_desc' => 'Essas permissões controlam o acesso padrão para os ativos dentro do sistema. Permissões em Notas, Capítulos e Páginas serão sobrescritas por essas permissões.',
