...
return [
    ...
    'app_default_editor' => 'Editor de Tópico Padrão',
    'app_default_editor_desc' => 'Selecione qual editor será usado por padrão ao editar novas tópicos. Isso pode ser substituído em um nível de tópico onde é permitido.',
    'app_custom_html' => 'Conteúdo customizado para <head> HTML',
    'app_custom_html_desc' => 'Quaisquer conteúdos aqui adicionados serão inseridos no final da seção <head> de cada tópico. Essa é uma maneira útil de sobrescrever estilos e adicionar códigos de análise de site.',
    'app_custom_html_disabled_notice' => 'O conteúdo customizado do <head> HTML está desabilitado nesta tópico de configurações, para garantir que quaisquer alterações danosas possam ser revertidas.',
    ...
    'app_homepage' => 'Tópico Inicial',
    'app_homepage_desc' => 'Selecione uma opção para ser exibida como tópico inicial em vez da padrão. Permissões de tópico serão ignoradas para as tópicos selecionadas.',
    'app_homepage_select' => 'Selecione uma tópico',
    'app_footer_links' => 'Links do Rodapé',
    'app_footer_links_desc' => 'Adicionar links para mostrar dentro do rodapé do site. Estes serão exibidos na parte inferior da maioria das tópicos, incluindo aqueles que não necessitam de login. Você pode usar uma etiqueta de "trans::<key>" para usar traduções definidas pelo sistema. Por exemplo: Usando "trans::common.privacy_policy" fornecerá o texto traduzido "Política de Privacidade" e "trans::common.terms_of_service" fornecerá o texto traduzido "Termos de Serviço".',
    ...
    'app_disable_comments_desc' => 'Desativar comentários em todas as tópicos no aplicativo.<br> Comentários existentes não serão exibidos.',
    ...
    'content_colors_desc' => 'Definir cores para todos os elementos na hierarquia da organização da tópico. Escolher cores com um brilho semelhante às cores padrão é recomendado para legibilidade.',
    'bookshelf_color' => 'Cor da Prateleira',
    'book_color' => 'Cor do Documentação',
    'chapter_color' => 'Cor do Artigo',
    'page_color' => 'Cor da Tópico',
    ...
    'maint_image_cleanup_desc' => 'Examina tópicos e revisa seus conteúdos para verificar quais imagens e desenhos estão atualmente em uso e quais são redundantes. Certifique-se de criar um backup completo do banco de dados e imagens antes de executar esta ação.',
    'maint_delete_images_only_in_revisions' => 'Também excluir imagens que existem apenas em revisões de tópico antigas',
    ...
    'maint_recycle_bin_desc' => 'Prateleiras, documentações, artigos e tópicos deletados são mandados para a lixeira podendo assim ser restaurados ou excluídos permanentemente. Itens mais antigos da lixeira podem vir a ser automaticamente removidos da lixeira após um tempo dependendo da configuração do sistema.',
    ...
    'role_manage_entity_permissions' => 'Gerenciar todos os documentações, artigos e permissões de tópicos',
    'role_manage_own_entity_permissions' => 'Gerenciar permissões de seu próprio documentação, artigo e paginas',
    'role_manage_page_templates' => 'Gerenciar modelos de tópico',
    ...
    'role_editor_change' => 'Alterar tópico de edição',
    ...
    'role_asset_desc' => 'Essas permissões controlam o acesso padrão para os ativos dentro do sistema. Permissões em Documentações, Artigos e Tópicos serão sobrescritas por essas permissões.',
    ...
    // Licensing
    'licenses' => 'Licenças',
    'licenses_desc' => 'Esta tópico detalha informações da licença do BookStack, além dos projetos e bibliotecas usadas no BookStack. Muitos projectos listados só podem ser utilizados num contexto de desenvolvimento.',
