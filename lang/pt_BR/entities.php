...
return [
    ...
    'shelves_drag_books' => 'Arraste os livros abaixo para adicioná-los a esta departamento',
    'shelves_empty_contents' => 'Esta departamento não possui livros atribuídos a ela',
    ...
    'shelves_delete_explain' => "Isso excluirá a departamento com o nome ':name'. Os livros contidos não serão excluídos.",
    'shelves_delete_confirmation' => 'Tem certeza de que deseja excluir esta departamento de livros?',
    ...
    'shelves_copy_permissions_explain' => 'Isso aplicará as configurações de permissão atuais desta departamento a todos os livros contidos nela. Antes de ativar, verifique se todas as alterações nas permissões desta prateleira foram salvas.',
