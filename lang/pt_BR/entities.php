...
return [
    ...
    'default_template_explain' => 'Atribuir o modelo de página que sera usado como padrão para todas as páginas criadas neste nota. Tenha em mente que isto será usado apenas se o criador da página tiver acesso de visualização ao modelo de página escolhido.',
    ...
    'permissions_book_cascade' => 'As permissões definidas em notas serão automaticamente em cascata para capítulos e páginas filho, a menos que tenham suas próprias permissões definidas.',
    ...
    'shelves_drag_books' => 'Arraste os notas abaixo para adicioná-los a esta departamento',
    'shelves_empty_contents' => 'Esta departamento não possui notas atribuídos a ela',
    ...
    'shelves_delete_explain' => "Isso excluirá a departamento com o nome ':name'. Os notas contidos não serão excluídos.",
    'shelves_delete_confirmation' => 'Tem certeza de que deseja excluir esta departamento de notas?',
    ...
    'shelves_permissions_cascade_warning' => 'As permissões nas prateleiras não são automaticamente em cascata para os notas contidos. Isso ocorre porque um nota pode existir em várias prateleiras. No entanto, as permissões podem ser copiadas para notas filhos usando a opção encontrada abaixo.',
    ...
    'shelves_copy_permissions_explain' => 'Isso aplicará as configurações de permissão atuais desta departamento a todos os notas contidos nela. Antes de ativar, verifique se todas as alterações nas permissões desta prateleira foram salvas.',
    ...
    'books_popular_empty' => 'Os notas mais populares aparecerão aqui.',
    'books_new_empty' => 'Os notas criados mais recentemente aparecerão aqui.',
    'books_create' => 'Criar Novo Nota',
    'books_delete' => 'Excluir Nota',
    'books_delete_named' => 'Excluir Nota :bookName',
    'books_delete_explain' => 'A ação vai excluir o nota com o nome \':bookName\'. Todas as páginas e capítulos serão removidos.',
    'books_delete_confirmation' => 'Você tem certeza que quer excluir o Nota?',
    'books_edit' => 'Editar Nota',
    'books_edit_named' => 'Editar Nota :bookName',
    'books_form_book_name' => 'Nome do Nota',
    'books_save' => 'Salvar Nota',
    ...
    'books_sort_desc' => 'Mova capítulos e páginas de um nota para reorganizar seu conteúdo. É possível acrescentar outros notas, o que permite uma movimentação fácil de capítulos e páginas entre notas.',
    ...
    'books_sort_show_other_desc' => 'Adicione outros notas aqui para incluí-los na operação de ordenação e permitir a reorganização fácil de todos os notas.',
    'books_sort_move_up' => 'Mover para cima',
    'books_sort_move_down' => 'Mover para baixo',
    'books_sort_move_prev_book' => 'Mover para Nota Anterior',
    ...
    'chapter_sort_book' => 'Classificar nota',
    ...
    'pages_delete_warning_template' => 'Está página atualmente esta atribuída como modelo de página padrão para algum nota ou capítulo. Estes notas ou capítulos não terão mais um modelo de página padrão atribuídos após essa página ser deletada.',
    ...
    'convert_to_shelf_contents_desc' => 'Você pode converter este nota em uma nova departamento com o mesmo conteúdo. Os capítulos contidos neste nota serão convertidos em novos notas. Se este nota contiver quaisquer páginas que não estejam em um capítulo, este nota será renomeado e conterá tais páginas, e este nota se tornará parte da nova departamento.',
    'convert_to_shelf_permissions_desc' => 'Todas as permissões definidas neste nota serão copiadas para a nova departamento e para todos os novos notas filhos que não tiverem suas próprias permissões aplicadas. Observe que as permissões nas departamentos não se propagam automaticamente para o conteúdo, como acontece com os notas.',
    'convert_book' => 'Converter Nota',
    'convert_book_confirm' => 'Tem certeza de que deseja converter este nota?',
    'convert_undo_warning' => 'Isso não pode ser desfeito tão facilmente.',
    'convert_to_book' => 'Converter em nota',
    'convert_to_book_desc' => 'Você pode converter este capítulo em um novo nota com o mesmo conteúdo. Quaisquer permissões definidas neste capítulo serão copiadas para o novo nota, mas quaisquer permissões herdadas, do nota pai, não serão copiadas, o que pode levar a uma alteração do controle de acesso.',
    ...
    'watch_detail_parent_book' => 'Acompanhando através do nota pai',
    'watch_detail_parent_book_ignore' => 'Ignorando através do nota pai',
