...
return [
    ...
    'tag' => 'Štítok',
    'tags' =>  'Štítky',
    'tags_index_desc' => 'Značky možno použiť na obsah v rámci systému a použiť flexibilnú formu kategorizácie. Značky môžu mať kľúč aj hodnotu, pričom hoddocumentação je voliteľná. Po použití je možné obsah vyhľadávať pomocou názvu a hodnoty značky.',
    'tag_name' =>  'Názov štítku',
    'tag_value' => 'Hoddocumentação štítku (Voliteľné)',
